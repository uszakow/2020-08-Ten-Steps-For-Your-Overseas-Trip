...
const excamples = [
    ...
    },
    {
        ...
        eng: "Weather application. On its example, I learned using API in applications and using asynchronous functions.",
        src: weather,
        alt: "Weather",
    ...
    return (
        <>
            ...
            <div className="aboutme-examples-wrap">
                {excamples.map((item, index) => (
                    <div className="aboutme-examples-card">
                        <a href={item.gitpage}>
